...
class GausBlur : Redactor() {
    ...
    private fun extrapolite(source: Image): Bitmap {
        ...
        var extrBitmap = Bitmap.createBitmap(
            srcBitmap.width + this.radius - 1,
        ...
        var bottomLine =
            srcPixels.sliceArray(IntRange(srcPixels.size - srcBitmap.width, srcPixels.size - 1))
        ...
        extrBitmap.getPixels(
            rightCol,
            0,
            1,
            extrBitmap.width - this.radius / 2 - 1,
            0,
            1,
            extrBitmap.height
        )
